...
namespace SDL2Sharp
{
    public ref struct PlanarImage<TPlanarColor>
    {
        private readonly Span<TPlanarColor> _pixels;
        ...
        public ref TPlanarColor this[int row, int column]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
        ...
        public unsafe PlanarImage(void* pixels, int height, int width, int pitch)
        {
            if (height < 0)
            {
                throw new ArgumentOutOfRangeException(
            ...
            _pixels = new Span<TPlanarColor>(pixels, height * pitch);
            _height = height;
            _width = width;
            _pitch = pitch;
        }
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref TPlanarColor DangerousGetReference()
        {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref TPlanarColor DangerousGetReferenceAt(int row, int column)
        {
