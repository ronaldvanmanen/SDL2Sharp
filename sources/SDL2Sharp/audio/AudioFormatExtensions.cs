...
namespace SDL2Sharp
{
    public static class AudioFormatExtensions
    {
        ...
        {
            return (ushort)format & Interop.SDL.SDL_AUDIO_MASK_BITSIZE;
        }

        public static bool IsFloat(this AudioFormat format)
        {
            return ((ushort)format & Interop.SDL.SDL_AUDIO_MASK_DATATYPE) != 0;
        }

        public static bool IsBigEndian(this AudioFormat format)
        {
            return ((ushort)format & Interop.SDL.SDL_AUDIO_MASK_ENDIAN) != 0;
        }

        public static bool IsSigned(this AudioFormat format)
        {
            return ((ushort)format & Interop.SDL.SDL_AUDIO_MASK_SIGNED) != 0;
        }
