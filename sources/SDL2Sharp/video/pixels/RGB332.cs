...
namespace SDL2Sharp
{
    ...
    public readonly record struct RGB332 : IPackedPixel<RGB332>
    {
        private static readonly PixelFormatDescriptor _formatDescriptor = new(PixelFormat.RGB332);
        ...
        {
            return new RGB332((byte)_formatDescriptor.MapRGB(r, g, b));
        }

        public static RGB332 FromRGBA(byte r, byte g, byte b, byte a)
        {
            return new RGB332((byte)_formatDescriptor.MapRGBA(r, g, b, a));
        }
