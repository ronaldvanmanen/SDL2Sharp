...
namespace SDL2Sharp
{
    ...
    public readonly record struct RGBA4444 : IPackedPixel<RGBA4444>
    {
        private static readonly PixelFormatDescriptor _formatDescriptor = new(PixelFormat.RGBA4444);

        public static PixelFormat Format => _formatDescriptor.Format;

        public static RGBA4444 FromRGB(byte r, byte g, byte b)
        {
            return new RGBA4444((ushort)_formatDescriptor.MapRGB(r, g, b));
        }

        public static RGBA4444 FromRGBA(byte r, byte g, byte b, byte a)
        {
            return new RGBA4444((ushort)_formatDescriptor.MapRGBA(r, g, b, a));
        }
