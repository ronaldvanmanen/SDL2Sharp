...
namespace SDL2Sharp.Interop.UnitTests
{
    ...
    public static unsafe class SDL_versionTests
    {
        /// <summary>Validates that the <see cref="SDL_version" /> struct is blittable.</summary>
        [Fact]
        public static void IsBlittableTest()
        {
            Assert.Equal(sizeof(SDL_version), Marshal.SizeOf<SDL_version>());
        }
        ...
        {
            Assert.True(typeof(SDL_version).IsLayoutSequential);
        }
        ...
        {
            Assert.Equal(3, sizeof(SDL_version));
        }
    }
}
